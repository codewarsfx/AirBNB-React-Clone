...
import "./airbnbdetails.css";
import HeaderLogo from "../../components/Logo/logocomponent";
import SearchButton from "../../components/Search/searchComponet";
import Navigation from "../../components/Nav/NavComponent";
			...
			{!isLoading && (
				<>
					<div className='details-container'>
						<HomeHero images={home.images} />
						<div className='details-description first'>
							<h1 className='details-description-title'>{home.name}</h1>
						...
						<div className='details-description details-description--flexed second'>
							<p className='details-description-status '>
								<span>This is a rare find.</span> Gestión De Activos Pedrana's
								place on Airbnb is usually fully booked.
							</p>
							<svg
								className='details-description-illustration'
								viewBox='0 0 48 48'
						...
						<div className='details-description details-description--flexed'>
							<div className='description-wrap'>
								<h1 className='details-description-title details-description-small'>
									Entire home hosted by Gestión De Activos Pedrana
								</h1>
								<p className='details-description-text details-description-text-big'>
									<span className='details-description-stats'>2 guests</span>
									<span className='details-description-seperation'></span>
									<span className='details-description-stats'>1 bedroom</span>
									<span className='details-description-seperation'></span>
									<span className='details-description-stats'>1 bed</span>
									<span className='details-description-seperation'></span>
									<span className='details-description-stats'>1 bath</span>
								</p>
							</div>
							<img
								className='details-description-img'
								aria-hidden='true'
								alt='Gestión De Activos Pedrana is a superhost. Learn more about Gestión De Activos Pedrana.'
								decoding='async'
								elementtiming='LCP-target'
								src='https://a0.muscache.com/im/pictures/user/076c9f5a-ee58-4b0b-b63c-017edd2405af.jpg?im_w=240'
								data-original-uri='https://a0.muscache.com/im/pictures/user/076c9f5a-ee58-4b0b-b63c-017edd2405af.jpg?im_w=240'
							/>
						</div>
						...
						<div className='details-description'>
							<img
								className='details-description-logo'
							...
							<a href='#' className='details-description-item-link'>
								Learn more
							</a>
						</div>
						...
						<div className='details-description'>
							<div className='details-description-item'>
								...
								<div className='detail-description-item-text'>
									...
									<a
										href='#'
										className='details-description-item-link'
										style={{ fontSize: "14px" }}
									>
										Show original language <BsChevronRight />
									</a>
								</div>
							</div>
							...
							<p className='detail-description-text-primary detail-description-text-primary--light'>
								Enjoy the sunrises from your private terrace and sleep lulled by
								the sound of the waves. This cozy house has a kitchen, bathroom
								and separate bedroom. Its peculiar architecture will make you
								fall in love and you won't be able to forget those breakfasts in
								bed overlooking the sea...
							</p>
							<a href='#' className='details-description-item-link'>
						...
						<div className='details-description details-description--pad'>
							...
							<div className='details-description-items'>
								<div className='detail-descriptions-item'>
									...
									<p className='checkout-text checkout-text--sec'>
										1 double bed
									</p>
								</div>
								<div className='detail-descriptions-item'>
							...
							<div className='checkout'>
								<div className='checkout-description'>
									...
									<div className='checkout-left'>
										<span className='details-description-stats details-description-stats--checkout'>
											<AiFillStar className='details-description-stats-icon' />
											5.0
										</span>
										<span className='details-description-stats details-description-stats-primary  details-description-stats--checkout'>
											18 reviews
										</span>
									</div>
								</div>
								<div className='checkout-input'>
									<div className='chekout-input-top'>
										<div className='checkout-input-container'>
											<span> CHECK OUT </span>
											<span className='checkout-input-date'>11/13/2022</span>
										</div>
										<div className='checkout-input-container'>
											<span> CHECK OUT </span>
											<span className='checkout-input-date'>11/13/2022</span>
									...
									<div className='checkout-input-bottom'>
										<div className='checkout-input-container'>
											<span> GUESTS </span>
											<span className='checkout-input-date'>1 guest</span>
										</div>
										<FaChevronDown className='checkout-icon' />
									</div>
								</div>
								<button className='registerion-form-input registerion-form-input--submit '>
									Reserve
								</button>
								<div className='details-description details-description--checkout'>
									<p className='checkout-text'>You won't be charged yet</p>
									<div className='checkout-item'>
										<span className='checkout-item-quantity'>5 nights</span>
										<span className='checkout-item-price'>${home.price}</span>
									</div>
									<div className='checkout-item'>
										<span className='checkout-item-quantity'>Service fee</span>
										<span className='checkout-item-price'>$10</span>
									</div>
								</div>
								<div className='detail-description-text-primary checkout-section'>
									<span>Total before taxes</span>
									<span className='checkout-item-price  '>$168</span>
								</div>
							</div>
						</div>
					</div>
					<div className='details-checkout'>
						<div className='details-checkout-left'>
							<p style={{ margin: "0px" }}>
								<span className='detail-description-text-primary'>
									${home.price}
								</span>
