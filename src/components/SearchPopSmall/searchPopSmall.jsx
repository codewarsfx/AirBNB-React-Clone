...
const SearchPopSmall = ({ toggleModal }) => {
	...
	return (
		<motion.div
			className='searchsmall-container'
			variants={dropIn}
			initial='hidden'
			animate='visible'
			exit='exit'
		...
		>
			<div className='searchsmall-wrapper'>
					...
					<nav className='searchsmall-header-tab'>
						<ul>
							<li>
								<a
									href='#'
									className='searchsmall-header-tab-link searchsmall-header-tab-link--active'
								>
									Stays
								</a>
							</li>
							<li>
								<a href='#' className='searchsmall-header-tab-link'>
									Experiences
								</a>
							</li>
						</ul>
				...
				<main className='searchsmall-main'>
					<h3 className='searchsmall-main-title'>Where to?</h3>
					<div className='searchsmall-main-input'>
						...
						<input
							type='text'
							className='searchsmall-main-input-element'
					...
					<div className='searchsmall-main-map'>
						<div className='searchmap-item searchmap-item--small searchmap-item--small--active'>
							...
							<p className='searchmap-item-label'>I'm flexible</p>
						</div>
						<div className='searchmap-item searchmap-item--small'>
							<div className='searchmap-item-image'>
								<img src='/assests/img/maps/africa.jpeg' alt='africa map' />
							</div>
							<p className='searchmap-item-label'>Africa</p>
						</div>
						<div className='searchmap-item searchmap-item--small'>
							<div className='searchmap-item-image'>
								<img
									src='/assests/img/maps/middleEast.jpeg'
									alt='Middle east map'
								/>
							</div>
							<p className='searchmap-item-label'>Middle East</p>
						</div>
						<div className='searchmap-item searchmap-item--small'>
							<div className='searchmap-item-image'>
								<img src='/assests/img/maps/pacific.jpeg' alt='pacific map' />
							</div>
							<p className='searchmap-item-label'>Pacific Islands</p>
						</div>
						<div className='searchmap-item searchmap-item--small'>
							<div className='searchmap-item-image'>
								<img src='/assests/img/maps/uk.jpeg' alt='uk map' />
							</div>
							<p className='searchmap-item-label'>United Kingdom</p>
						</div>
						<div className='searchmap-item searchmap-item--small'>
							<div className='searchmap-item-image'>
								<img src='/assests/img/maps/us.jpeg' alt='us map' />
							</div>
							<p className='searchmap-item-label'>United States</p>
						</div>
					</div>
				</main>
				<motion.div
				...
				>
					<span className='searchmap-bar-right'>When</span>
					<span className='searchmap-bar-left'>Add dates</span>
				</motion.div>
				<motion.div
					...
					className='searchmap-bar'
				>
					<span className='searchmap-bar-right'>Who</span>
					<span className='searchmap-bar-left'>Add guests</span>
				</motion.div>
			</div>
		</motion.div>
	);
